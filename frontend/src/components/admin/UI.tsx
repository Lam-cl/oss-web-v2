...
export function ErrorState({ message, retry }: { message: string; retry: () => void }) { return <div className="adm-error"><div><strong>Data tidak dapat dimuatkan</strong><p>{message}</p></div><button className="adm-button secondary" onClick={retry}><Icon name="retry" /> Cuba lagi</button></div>; }
