...
export default function Header() {
  ...
  const [logoOnlyHeader, setLogoOnlyHeader] = useState(false);
  ...
  return (
    <header className={`site-header${logoOnlyHeader ? ' site-header--logo-only' : ''}`}>
      <div className={`header-inner${logoOnlyHeader ? ' header-inner--logo-only' : ''}`}>
        {logoOnlyHeader ? (
        ...
        {!logoOnlyHeader && (
          <>
            <nav className="header-nav">
              ...
              <Link href="/cart" className="nav-cart relative" data-cart-target>
