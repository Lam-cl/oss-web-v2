...
const names = ['DATA_API_SERVICE_TOKEN','DATABASE_URL','PUBLIC_MEDIA_BASE_URL','MINIO_ENDPOINT','MINIO_ACCESS_KEY','MINIO_SECRET_KEY','SESSION_ENCRYPTION_KEY'] as const;
