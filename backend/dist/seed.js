...
const banner_entity_1 = require("./banners/banner.entity");
...
const AppDataSource = new typeorm_1.DataSource({
    ...
    entities: [brand_entity_1.Brand, device_entity_1.Device, banner_entity_1.Banner, plan_entity_1.Plan],
    synchronize: true,
});
async function seed() {
    ...
    const bannerRepo = AppDataSource.getRepository(banner_entity_1.Banner);
    const planRepo = AppDataSource.getRepository(plan_entity_1.Plan);
